...
public class NBAWarriorsShopPageObjects {
    ...
    public CustomWebElement productName_radioButton = new CustomWebElement(Locators.XPATH, "//div[@data-trk-id='all-departments']//ul//span[text()='ProductName']", "ProductName radio button");
    ...
    public CustomWebElement nextPage_button = new CustomWebElement(Locators.XPATH, "//li[@class='next-page']", "Next page navigation");
